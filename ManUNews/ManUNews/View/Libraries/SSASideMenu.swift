...
extension UIViewController {
    ...
    func hideMenuViewController(animated bool: Bool) {
        sideMenuViewController?.hideMenuViewController(bool)
    }
}
...
class SSASideMenu: UIViewController, UIGestureRecognizerDelegate {
    ...
    struct ContentViewEffect {
        ...
        var alpha: Float = 1.0
        var scale: Float = 0.7
        var leftLandscapeOffsetX: Float = 30
        var rightLandscapeOffsetX: Float = 30
        var leftPortraitOffsetX: Float = 30
        var rightPortraitOffsetX: Float = 30
        ...
        init(alpha: Float = 1.0, scale: Float = 0.7,
             leftLandscapeOffsetX: Float = 30, rightLandscapeOffsetX: Float = 30,
             leftPortraitOffsetX: Float = 30, rightPortraitOffsetX: Float = 30,
            ...
            self.alpha = alpha
            self.scale = scale
            self.leftLandscapeOffsetX = leftLandscapeOffsetX
            self.rightLandscapeOffsetX = rightLandscapeOffsetX
            self.leftPortraitOffsetX = leftPortraitOffsetX
            self.rightPortraitOffsetX = rightPortraitOffsetX
    ...
    struct SideMenuOptions {
        ...
        var leftType: SSASideMenuType = .scale
        var rightType: SSASideMenuType = .scale
        ...
        init(animationDuration: Float = 0.35, panGestureEnabled: Bool = true, panDirection: SSASideMenuPanDirection = .edge, leftType: SSASideMenuType = .scale, rightType: SSASideMenuType = .scale, panMinimumOpenThreshold: UInt = 60, menuViewControllerTransformation: CGAffineTransform = CGAffineTransform(scaleX: 1.5, y: 1.5), backgroundTransformation: CGAffineTransform = CGAffineTransform(scaleX: 1.7, y: 1.7), endAllEditing: Bool = false) {
    ...
    func configure(_ configuration: ContentViewEffect) {
        ...
        contentViewInLandscapeLeftOffsetCenterX = configuration.leftLandscapeOffsetX
        contentViewInLandscapeRightOffsetCenterX = configuration.rightLandscapeOffsetX
        contentViewInPortraitLeftOffsetCenterX = configuration.leftPortraitOffsetX
        contentViewInPortraitRightOffsetCenterX = configuration.rightPortraitOffsetX
    ...
    func configure(_ configuration: SideMenuOptions) {
        ...
        leftType = configuration.leftType
        rightType = configuration.rightType
    ...
    @IBInspectable var contentViewInLandscapeLeftOffsetCenterX: Float = 30.0
    @IBInspectable var contentViewInLandscapeRightOffsetCenterX: Float = 30.0
    @IBInspectable var contentViewInPortraitLeftOffsetCenterX: Float = 30.0
    @IBInspectable var contentViewInPortraitRightOffsetCenterX: Float = 30.0
    ...
    @IBInspectable var leftType: SSASideMenuType = .scale
    @IBInspectable var rightType: SSASideMenuType = .scale
    ...
    fileprivate func animateMenuViewController(_ side: SSASideMenuSide) {
        ...
        if side == .left {
            ...
            let centerXLandscape = CGFloat(contentViewInLandscapeLeftOffsetCenterX) + (iOS8 ? CGFloat(view.frame.width) : CGFloat(view.frame.height))
            let centerXPortrait = CGFloat(contentViewInPortraitLeftOffsetCenterX) + CGFloat(view.frame.width)
            ...
            let centerXLandscape = -CGFloat(self.contentViewInLandscapeRightOffsetCenterX)
            let centerXPortrait = CGFloat(-self.contentViewInPortraitRightOffsetCenterX)
    ...
    func panGestureRecognized(_ recognizer: UIPanGestureRecognizer) {
        ...
        if recognizer.state == .changed {
            ...
            var contentViewScale: CGFloat
            if leftMenuVisible {
               contentViewScale = leftType == .scale ? 1 - ((1 - CGFloat(contentViewScaleValue)) * delta) : 1
            }
            else {
                contentViewScale = rightType == .scale ? 1 - ((1 - CGFloat(contentViewScaleValue)) * delta) : 1
            }
